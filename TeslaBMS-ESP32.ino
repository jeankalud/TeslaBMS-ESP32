...
#define BMS_BAUD  631578 // V2
//#define BMS_BAUD  612500 // V1
...
void setup() 
{
    ...
    SERIAL.begin(BMS_BAUD, SERIAL_8N1, 18, 17); // RX pin is 18, TX pin is 17
    SERIALCONSOLE.println("Started serial interface to BMS.");
    pinMode(13, INPUT); // Setup FAULT hardware line as input
